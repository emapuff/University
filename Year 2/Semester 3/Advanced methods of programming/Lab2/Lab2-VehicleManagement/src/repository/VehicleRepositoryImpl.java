...
public class VehicleRepositoryImpl implements VehicleRepository {
	...
	public void addVehicle(Vehicle newVehicle) {
		...
		if (!newVehicle.isInactive() && numberOfVehicles < MAX_CAPACITY) {
			vehicles[numberOfVehicles] = newVehicle;
			numberOfVehicles++;
		} else {
			System.out.println(newVehicle.isInactive() ? "Vehicle is inactive" : "No vehicles can be added to the stock");
		}
