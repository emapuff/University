...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        initView(stage, beginningService,pendingRequestsRepository,network);
        stage.setWidth(600);
    ...
    private void initView(Stage primaryStage, BeginningService beginningService, PendingRequestsRepository pendingRequestsRepository,Network network) throws IOException {
